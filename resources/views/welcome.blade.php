...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'FamilyEvent') }}</title>
    ...
    <main>
        ...
        <section class="bgColor-lightGray" id="about">
            <div class="container section-top">
                <div class="row">
                    <div class="col">
                        <h2 class="section-top-title"><span>突然ですがお父さんお母さんこんな悩みはありませんか？</span></h2>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img src="{{asset('img//登録画面.png')}}" width="30%" height="130">
                        </div>
                    </div>
                </div>
                <div class="col-2 arrow-space">
                    <i class="fas fa-arrow-alt-circle-right fa-2x"></i>
                </div>
                <div class="col-5">
                    <div class="card">
                        <div class="card-header">
                            <p>マイページからイベント/写真投稿</p>
                        </div>
                        <div class="card-body">
                            <img src="{{asset('img//マイページ.png')}}" width="30%" height="130">
                        </div>
                    </div>
                </div>
            </div>
